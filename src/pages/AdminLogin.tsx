        ...
        <div className="p-8 space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="flex justify-center">
              <div className="w-20 h-20 gradient-accent rounded-2xl flex items-center justify-center shadow-medium">
                <Shield className="w-10 h-10 text-white" />
              </div>
            </div>
            <div>
              <h2 className="text-3xl font-bold text-foreground">Admin Login</h2>
              <p className="text-muted-foreground mt-2">Full system administration access</p>
            </div>
          </div>
